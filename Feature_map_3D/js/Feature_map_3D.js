function create_box_check(){
  ...
  svg = document.querySelector("svg");
    ...
    if(e>=3){
      ...
      if(((((columns-f_height +1)-f_height1 +1)-f_height2 +1)>=1)&&((((rows-f_width+1)-f_width1+1)-f_width2+1)>=1)&&
      (((columns-f_height +1)-f_height1 +1)>=1)&&(((rows-f_width+1)-f_width1+1)>=1)&&
      ((columns-f_height +1)>=1)&&((rows-f_width+1)>=1)&&
      (columns>=1)&&(rows>=1)){
      createBoxes_2();
      }
      else{
      ...
      if((((columns-f_height +1)-f_height1 +1)>=1)&&(((rows-f_width+1)-f_width1+1)>=1)&&
      ((columns-f_height +1)>=1)&&((rows-f_width+1)>=1)&&
      (columns>=1)&&(rows>=1)){
      createBoxes_1();
      }
      ...
      if(((columns-f_height +1)>=1)&&((rows-f_width+1)>=1)&&
      (columns>=1)&&(rows>=1)){
      createBoxes();
       }
       else{
