...
function FCNN() {
    ...
    let textFn = (layer_index, layer_width) => ((layer_index === 0 ? "Input(Sigmoid)" : (layer_index === architecture.length-1 ? "Output(SoftMax)" : "Hidden(Sigmoid)")) + " Layer ∈ ℝ" + sup(layer_width.toString())); // Layer
